...
const RubleIcon = () => (
    <span style={{ fontWeight: 600, fontSize: '0.95em', marginLeft: '2px' }}>₽</span>
);
            ...
            .filter((order) => {
                ...
                if (selectedStatus !== 'Все') {
                    if (selectedStatus === 'Оформлен') {
                        // Include blank/undefined statuses as "Оформлен" for compatibility
                            ...
                            <div key={order.id} className="order-card-new">
                                ...
                                <div className="card-details">
                                    ...
                                    <div className="items-preview">
                                        ...
                                        {itemsCount > 3 && (
                                            <div className="more-items">...и еще {itemsCount - 3} поз.</div>
                                        )}
                                    </div>
                                </div>
